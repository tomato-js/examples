(function () {
	...
	exports.shared = lib$2;
	});

	unwrapExports(lib$4);
	var lib_1$2 = lib$4.element;
	var lib_2 = lib$4.env;
	var lib_3 = lib$4.path;
	var lib_4 = lib$4.shared;

	const classNode = lib$4.element.get('.j-class');
	const idNode = lib$4.element.get('j-id');
	const queryObje = lib$4.path.parse('?a=123&b=456');
